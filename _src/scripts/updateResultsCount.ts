function updateResultsCount(results: number) {
  ...
  if (results === -1) {
    ...
    resultsCount.innerHTML = `
      ...
      <svg class="text-blue-200 animate-spin dark:text-gray-600 fill-blue-900" viewBox="0 0 100 101" width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg" pointer-events="none" aria-hidden="true">

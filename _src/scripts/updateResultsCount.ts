function updateResultsCount(results: number) {
  ...
  if (results === -1) {
    /* SEARCHING: BLUE */
    resultsCount.setAttribute("class", "flex justify-between items-center max-w-2xl mx-auto p-4 mb-4 text-sm text-blue-700 bg-blue-100 rounded-lg dark:bg-blue-200 dark:text-blue-800");
    resultsCount.innerHTML = `
      Searching...

      <svg class="text-blue-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg" pointer-events="none" aria-hidden="true">
